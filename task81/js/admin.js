$(function() {
    function refreshNews(newsType) {
        $.ajax({
            url: '../testphp/server/getnews.php',
            type: 'GET',
                    ...
                    $edit.click(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('#enewstime').val(data[0].newstime.split(' ')[0]);
    ...
    function refreshNews(newsType) {
        $.ajax({
            url: '../testphp/server/getnews.php?newtype=' + newsType,
            type: 'GET',
            data: { newstype: newsType },
            datatype: 'json',
            success: function(data) {
